...
public class Ejercicio19 {
	...
	public static void main(String[] args) throws NumberFormatException, IOException
	{
		...
		*/
		...
		String rta="y";
		while(rta.equals("y"))
		{	System.out.println("porque lado desea eliminar los elementos? izq/der");
			rta = br.readLine();
			...
			System.out.println("Desea volver a eliminar elementos? y/n");
			rta=br.readLine();
		}
	...
	{
		System.out.println("Ha decidido eliminar elementos por izquierda");
		
		System.out.println("Cuantos elementos desea eliminar?");
	...
	{
		System.out.println("Ha decidido eliminar elementos por derecha");
		System.out.println("Cuantos elementos desea eliminar?");
		int rta = Integer.parseInt(br.readLine());
